...
def process_single_response(
    ...
    """Process a single response: remove sentences and generate completion.
    ...
    print(
        f"  Response {response_idx}: Generating completion ({n_sentences_removed} sentences removed = {percentage_removed:.1f}% of {original_sentence_count} sentences)..."
    )
    ...
    return {
        ...
        "modified_sentence_count": modified_sentence_count,
